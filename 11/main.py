...
#     Actual data: http://py4e-data.dr-chuck.net/regex_sum_1764057.txt (There are 112 values and the sum ends with 55)
...
print(sum([int(i) for i in re.findall('[0-9]+', open("regex_sum_1764057.txt").read())]))
